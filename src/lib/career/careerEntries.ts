...
export const additionalWorkEntries: Array<CareerEntry> = [
  {
    ...defaultEntryValues,
    companyLogo:
      "https://cloud.elgiganten.dk/resources/images/logo/partner_old.555562c08e.png",
  ...
  },
  {
    ...defaultEntryValues,
    companyLogo:
      "https://upload.wikimedia.org/wikipedia/en/thumb/5/54/TDC.svg/1200px-TDC.svg.png",
    companyName: "TDC",
    position: "IT Support",
