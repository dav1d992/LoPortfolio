...
const ProjectsPage = () => {
  const projects = [
    ...
    },
    {
      title: "ChessMeOut",
      description:
        "An interactive chess analysis tool designed for players to study games and explore openings. Features an opening selector to learn popular chess variations and analyze positions. Perfect for chess enthusiasts looking to improve their game.",
